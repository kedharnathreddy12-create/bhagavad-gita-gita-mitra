...
export default function KrishnaStoryPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <Link href="/stories/krishna" className="inline-flex items-center gap-2 text-accent-gold hover:text-accent-saffron mb-8 transition-colors">
