    ...
    <footer className="glass-panel border-t border-white/10 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-xl text-gradient">GitaMitra</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-text-secondary">
              ...
              <li><Link href="/experience" className="hover:text-accent-gold transition">మీ అనుభవం</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 text-center text-sm text-text-secondary">
          <p>© {new Date().getFullYear()} GitaMitra. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
